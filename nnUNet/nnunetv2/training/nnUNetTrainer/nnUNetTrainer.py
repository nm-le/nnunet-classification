...
from nnunetv2.training.dataloading.nnunet_dataset import nnUNetDatasetMultiTask
...
class nnUNetTrainer(object):
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            dataset = nnUNetDatasetMultiTask(self.preprocessed_dataset_folder, case_identifiers=None,
                ...
                if next_stages is not None:
                    for n in next_stages:
                        ...
                        try:
                            ...
                            tmp = nnUNetDatasetMultiTask(expected_preprocessed_folder, [k],
                                                num_images_properties_loading_threshold=0)
